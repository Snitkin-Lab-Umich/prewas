...
A visualization of these 3 steps in the prewas workflow is shown below where B shows how prewas multialleleic sites, C shows options for choosing a reference allele and D shows how prewas can group SNPs into genes. A detailed workflow indicating required file inputs can be seen below in the "Detailed prewas workflow" section. 
