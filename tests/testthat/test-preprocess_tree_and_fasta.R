...
# root_tree -------------------------------------------------------------------#
test_that("Check that root_tree roots tree and drops outgroup when given valid inputs", {
...
test_that("Check that root_tree() gives error for invalid inputs", {
  # No tree input
...
test_that("Check that subset_tree_and_matrix() works as expected on valid inputs", {
...
test_that("Check that subset_tree_and_matrix() gives error when given invalid inputs", {
  # No tree
